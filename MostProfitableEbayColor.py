...
import re
#In this project we are going to analyze ebay purchases. We'll check what is the most profitable color category, If Price and the number of stars a product got had something to do in comman
sales = pd.read_csv('marketing_sample_for_ebay_com-ebay_com_product__20210101_20210331__30k_data.csv',sep=',',on_bad_lines='skip')
...
#we can see that there are sum null values. In order not to lose data lest replace those values with the Average value of the series
...
sales2 = pd.read_csv('marketing_sample_for_ebay_com-ebay_com_product__20210101_20210331__30k_data.csv',sep=',',on_bad_lines='skip')
