...
sales['Seller Rating']=sales['Seller Rating'].replace(np.nan,mean_val)
...
def seller_rating_buckets(rating):
    ...
    if rating>98:
        ...
        return 'Low'
print(sales['Price'].corr(sales['Seller Rating']))#0.017933515545626052
...
print(pivot_sales)
print(sales.columns)
pivot_sales.plot(kind='bar',figsize=(7,8))
plt.xlabel('Rating')
